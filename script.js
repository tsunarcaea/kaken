...
function loadQuiz() {
    ...
    quizContainer.innerHTML = `
        ...
        <div id="explanation" style="display: none; margin-top: 20px; padding: 10px; background: #e9ecef; border-radius: 5px;"></div>
    `;
}
...
function showResults() {
    ...
    if (percentage === 100) {
        message = "素晴らしい！すべての問題に答えました。無断転載に対する高度な理解度をお持ちです。";
